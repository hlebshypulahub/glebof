...
//
//    public BotService(final UserService userService, final CouponService couponService, final BotUtilityService botUtilityService, final PharmacyService pharmacyService, @Lazy final OFBot OFBot) {
...
//        this.sendMusicFileCallback = OFBot.getSendMusicFileCallback();
//        this.sendMessageWithInputFileCallback = OFBot.getSendMessageWithInputFileCallback();
